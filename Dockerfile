...
ENV EPISODES_AUX_CHAT_ID=${EPISODES_AUX_CHAT_ID}
ENV EPISODES_TOC_MESSAGE_ID=${EPISODES_TOC_MESSAGE_ID}
ENV EPISODES_URL_NAME=${EPISODES_URL_NAME}
ENV EPISODES_RESERVE_CHAT_ID=${EPISODES_RESERVE_CHAT_ID}
ENV EPISODES_SHOULD_REPLICATE=${EPISODES_SHOULD_REPLICATE}
